  ...
  formatResult(rows) {
    ...
    rows = rows.map((row) => {
      ...
      subQueries.forEach((subQuery) => {
        ...
        objectPath.set(formattedRow, fieldPath, subquery.formatResult)
        // objectPath.set()
        console.log(subQuery.relationship.fieldPath);
        console.log(row[subQuery.relationship.relationshipName].records);
      });
